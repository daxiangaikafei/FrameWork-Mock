...
"<h2>Title</h2>\n    <p>Text</p>\n    <fieldset>\n  <div  class='field'><span>请求类型:</span> <select id='apiMethod'><option value='1'>GET</option><option value='2'>POST</option><option value='3'>PUT</option><option value='4'>DELETE</option><option value='5'>PATCH</option></select></div>    <input type=\"text\" tabIndex=\"3\" id='apiName'/>\n   <input type=\"text\" tabIndex=\"3\" placeholder='API描述' id='apiDesc'/>\n   <input type=\"text\" tabIndex=\"3\" placeholder='路由地址' id='apiKey'/>\n  <div   style='display:none'><span style='width:87px'>动态数据：</span><input type=\"checkbox\" tabIndex=\"3\" id='isDynamic'/> </div><div    style='display:none'><span style='width:139px'>重复字段及数量：</span><input tabIndex=\"3\" type='input' id='loops' placeholder='仅数字(data) 或 details:10,list:10形式'/></div>   <textarea  tabIndex=\"3\" placeholder='API输出(例：{\"a\":\"b\"})'  id='jsonValue'></textarea>\n <div class=\"sa-input-error\"></div>\n    </fieldset>" +
