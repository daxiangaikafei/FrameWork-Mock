...
"<h2>Title</h2>\n    <p>Text</p>\n    <fieldset>\n  <span>请求类型:</span> <select id='apiMethod'><option value='1'>GET</option><option value='2'>POST</option></select>\n    <input type=\"text\" tabIndex=\"3\" id='apiName'/>\n   <input type=\"text\" tabIndex=\"3\" placeholder='API描述' id='apiDesc'/>\n   <input type=\"text\" tabIndex=\"3\" placeholder='路由地址' id='apiKey'/>\n     <textarea  tabIndex=\"3\" placeholder='API输出(例：{\"a\":\"b\"})'  id='jsonValue'></textarea>\n <div class=\"sa-input-error\"></div>\n    </fieldset>" +
